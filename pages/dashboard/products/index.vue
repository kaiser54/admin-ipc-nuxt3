  ...
  <div>
    ...
    <div class="dash__container">
      <div class="dash__card">
        ...
        <DynamicDashCard cardName="Categories" counterName="24" :active="true">
          <template v-slot:svg>
            <svg
              width="20"
              height="20"
        ...
        <DynamicDashCard cardName="Instock" counterName="102">
          <template v-slot:svg>
            <svg
              width="20"
              height="20"
        ...
        <DynamicDashCard cardName="Out of stock" counterName="8">
          <template v-slot:svg>
            <svg
              width="20"
              height="20"
