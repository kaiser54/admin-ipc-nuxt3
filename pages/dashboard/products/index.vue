  ...
  <MainLayout>
    <div>
      <div class="dash__button">
        <DynamicButton class="auto" buttonText="Create new category" size="standard" type="neutral" icon="icon-left"
          :disabled="true">
          <template v-slot:svg>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="add-plus">
                <path id="Vector" d="M4.1665 9.99984H15.8332M9.99984 4.1665V15.8332V4.1665Z" stroke="#BDC0CE"
                  stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </g>
            </svg>
          </template>
        </DynamicButton>
        <DynamicButton @clickButton="redirectToCreateProductPage" class="auto" buttonText="Add new product"
          size="standard" type="primary" icon="icon-left">
          <template v-slot:svg>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="add-plus">
                <path id="Vector" d="M4.1665 9.99984H15.8332M9.99984 4.1665V15.8332V4.1665Z" stroke="#BDC0CE"
            ...
            <template v-slot:svg>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="tag-price-discount">
                  ...
                  <path id="Vector_2" d="M5.84692 5.84692L5.8335 5.8335" stroke="#565C69" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" />
                </g>
              </svg>
            </template>
          </DynamicDashCard>
          <DynamicDashCard cardName="Categories" :counterName="categoriesCount" :active="true">
            <template v-slot:svg>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="menu-hambuger">
                  <path id="Vector" d="M4.1665 5.8335H15.8332" stroke="#565C69" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path id="Vector_2" d="M4.1665 10H15.8332" stroke="#565C69" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path id="Vector_3" d="M4.1665 14.1665H15.8332" stroke="#565C69" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                </g>
              </svg>
            </template>
