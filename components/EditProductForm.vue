                        ...
                        <div class="form__field">
                            <div class="input-field">
                                ...
                                <div class="input-container">
                                    ...
                                    }" type="number" name="slash" id="" placeholder="₦80,000" required v-model="formData.actualPrice"
              ...
              />
                    ...
                    <div class="fourth">
                        ...
                        <div class="imgg">
                            ...
                            <input type="file" ref="fileInput" multiple @change="handleFileChange" accept="image/*" />
                        </div>
                        <div v-if="previewImages.length" class="flex">
                            <div v-for="(image, index) in previewImages" :key="index" class="flexed-image">
