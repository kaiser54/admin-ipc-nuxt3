<template>
  <div class="w-[595px] container mx-auto py-8 px-9 bg-white">
    <img
      alt=""
      src="https://res.cloudinary.com/djqlxamam/image/upload/v1695908857/ipc-invoice-logo_vlr58l.svg"
      class="mb-3"
    />
    <div class="flex justify-end">
      <div class="mb-6">
        <p class="text-xs mb-3 text-[#7E8494]">Bill to:</p>
        <p class="text-sm text-[#303237] mb-1 font-medium">Papa’s grill</p>
        <p class="text-xs text-[#7E8494]">papasgrill@gmail.com</p>
        <div
    ...
    <div>
      <div class="grid grid-cols-4">
        <div>
          ...
          <p class="text-xs text-[#303237] font-medium">31 Jul, 2023</p>
        </div>
        <div>
          <p class="text-xs text-[#7E8494] mb-3">Order Time</p>
          <p class="text-xs text-[#303237] font-medium">07:52 PM</p>
        </div>
        <div>
          <p class="text-xs text-[#7E8494] mb-3">Delivery Date</p>
          <p class="text-xs text-[#303237] font-medium">1 Aug, 2023</p>
        </div>
        <div>
          ...
          <div class="flex gap-1 items-center">
            <img
              alt=""
              src="https://res.cloudinary.com/djqlxamam/image/upload/v1695908860/card_zj9dxa.svg"
            />
            <span class="text-xs text-[#303237] font-medium"
              >xxx xxxx xxxx 1234</span
            >
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-4">
        <div>
          ...
          <p class="text-xs text-[#303237] font-medium">IPC-000927</p>
        </div>
        <div>
          <p class="text-xs text-[#7E8494] mb-3">Order Id</p>
          <p class="text-xs text-[#303237] font-medium">1234567</p>
        </div>
        <div>
          <p class="text-xs text-[#7E8494] mb-3">No. of orders</p>
          <p class="text-xs text-[#303237] font-medium">4</p>
        </div>
        <div>
          <p class="text-xs text-[#7E8494] mb-3">Delivery Address</p>
          <p class="text-xs text-[#303237] font-medium">
            34A, Deborah Doralty, Admiralty, Lekki Phase 1, Lagos Nigeria
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="my-10">
      <table class="table-auto w-full border-spacing-10">
        ...
        <tbody class="text-xs w-full text-left">
          <tr class="border-b border-b-[#E5E7EF]">
            <th class="pl-3">1</th>
            <td class="py-4 px-3">
              <div class="flex items-center gap-x-1">
                <img
                  alt=""
                  src="https://res.cloudinary.com/djqlxamam/image/upload/v1695908859/product_ntlvy6.svg"
                />
                <p class="#565C69 font-medium">Mama'S Choice Nigeria...</p>
              </div>
            </td>
            <td class="py-4 px-3">
            ...
            <td class="text-[#565C69] text-center">₦ 7,500</td>
            <td class="text-[#303237] text-right font-medium">₦ 75,000</td>
          </tr>
          <tr class="border-b border-b-[#E5E7EF]">
            <th class="pl-3">2</th>
            <td class="py-4 px-3">
    ...
    <div class="pl-3 mb-10">
      <div class="border-b border-b-[#E5E7EF] pb-4">
        <div class="flex items-center justify-between pb-4">
          ...
          <p class="text-sm text-[#303237] font-medium">₦ 300,000</p>
        </div>
        <div class="flex items-center justify-between">
          <p class="text-[#565C69] text-xs">Delivery fee</p>
          <p class="text-sm text-[#303237] font-medium">₦ 1,245</p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <p class="text-base text-[#303237] font-medium">₦ 301,245</p>
      </div>
    </div>
    ...
    <footer class="text-xs">
      ...
      <div>
        ...
        <p class="text-[#565C69]">
          ...
          eligible for return. All defected goods should not be tampered with as
          we would withdraw them for replacement.
        </p>
      </div>
    </footer>
  </div>
...
export default {
  props: {
    invoiceData: Object, // Pass invoice data as a prop
  },
};
</script>
